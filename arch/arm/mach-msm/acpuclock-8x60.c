...
#define MAX_VDD_SC		1450000 /* 1325000  uV */
#define MIN_VDD_SC		750000 /* uV anryl 812500*/
#define MAX_VDD_MEM		1450000 /* 1325000 uV */
...
static struct clkctl_acpu_speed acpu_freq_tbl_1188OCmhz[] = {
...
uint32_t acpu_check_khz_value(unsigned long khz)
{
	...
	for (f = acpu_freq_tbl_1188OCmhz; f->acpuclk_khz != 0; f++) {
		if (khz < 192000) {
...
static __init struct clkctl_acpu_speed *select_freq_plan(void)
{
	...
	struct clkctl_acpu_speed *f;
		...
		acpu_freq_tbl = acpu_freq_tbl_1188OCmhz;
