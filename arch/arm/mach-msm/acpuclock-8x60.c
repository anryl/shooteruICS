...
#define L_VAL_SCPLL_CAL_MAX    0x1c /* =  1512000 MHz with 27MHz source */
...
#if CONFIG_MAX_CLOCK == 1512000
	[4] = BW_MBPS(2560), /* At least 320 MHz on bus. */
	#endif
#if CONFIG_MAX_CLOCK == 1836000
	[4] = BW_MBPS(2672), /* At least 334 MHz on bus. */
#endif
};
...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	...
	[1]  = { 432000,  1, 0x08, 1000000, 1100000, 2},
	[2]  = { 486000,  1, 0x09, 1000000, 1100000, 2},
	[3]  = { 540000,  1, 0x0A, 1000000, 1100000, 2},
	[4]  = { 594000,  1, 0x0B, 1000000, 1100000, 2},
	[5]  = { 648000,  1, 0x0C, 1000000, 1100000, 3},
	[6]  = { 702000,  1, 0x0D, 1100000, 1100000, 3},
	[7]  = { 756000,  1, 0x0E, 1100000, 1100000, 3},
	...
	[19] = {1404000,  1, 0x1A, 1225000, 1225000, 4},
	[20] = {1458000,  1, 0x1B, 1225000, 1225000, 4},
	[21] = {1566000,  1, 0x1C, 1200000, 1225000, 4},
}; 
...
static struct clkctl_acpu_speed acpu_freq_tbl_v2[] = {
  ...
  { {1, 1},  432000,  ACPU_SCPLL, 0, 0, 1, 0x08, L2(7),   850000, 0x03006000},
  { {1, 1},  486000,  ACPU_SCPLL, 0, 0, 1, 0x09, L2(7),   850000, 0x03006000},
  { {1, 1},  540000,  ACPU_SCPLL, 0, 0, 1, 0x0A, L2(7),   875000, 0x03006000},
  { {1, 1},  594000,  ACPU_SCPLL, 0, 0, 1, 0x0B, L2(7),   875000, 0x03006000},
  { {1, 1},  648000,  ACPU_SCPLL, 0, 0, 1, 0x0C, L2(7),   900000, 0x03006000},
  { {1, 1},  702000,  ACPU_SCPLL, 0, 0, 1, 0x0D, L2(7),   900000, 0x03006000},
  { {1, 1},  756000,  ACPU_SCPLL, 0, 0, 1, 0x0E, L2(7),   925000, 0x03006000},
  { {1, 1},  810000,  ACPU_SCPLL, 0, 0, 1, 0x0F, L2(7),   925000, 0x03006000},
  { {1, 1},  864000,  ACPU_SCPLL, 0, 0, 1, 0x10, L2(7),   950000, 0x03006000},
  { {1, 1},  918000,  ACPU_SCPLL, 0, 0, 1, 0x11, L2(7),  950000, 0x03006000},
  { {1, 1},  972000,  ACPU_SCPLL, 0, 0, 1, 0x12, L2(7),  950000, 0x03006000},
  { {1, 1}, 1026000,  ACPU_SCPLL, 0, 0, 1, 0x13, L2(7),  975000, 0x03006000},
#if CONFIG_MAX_CLOCK == 1512000
  { {1, 1}, 1080000,  ACPU_SCPLL, 0, 0, 1, 0x14, L2(18), 1000000, 0x03006000},
  { {1, 1}, 1134000,  ACPU_SCPLL, 0, 0, 1, 0x15, L2(18), 1000000, 0x03006000},
  { {1, 1}, 1188000,  ACPU_SCPLL, 0, 0, 1, 0x16, L2(18), 1025000, 0x03006000},
  { {1, 1}, 1242000,  ACPU_SCPLL, 0, 0, 1, 0x17, L2(18), 1050000, 0x03006000},
  { {1, 1}, 1296000,  ACPU_SCPLL, 0, 0, 1, 0x18, L2(18), 1075000, 0x03006000},
  { {1, 1}, 1350000,  ACPU_SCPLL, 0, 0, 1, 0x19, L2(18), 1100000, 0x03006000},
  { {1, 1}, 1404000,  ACPU_SCPLL, 0, 0, 1, 0x1A, L2(18), 1100000, 0x03006000},
  { {1, 1}, 1458000,  ACPU_SCPLL, 0, 0, 1, 0x1B, L2(18), 1100000, 0x03006000},
  { {1, 1}, 1512000,  ACPU_SCPLL, 0, 0, 1, 0x1C, L2(18), 1125000, 0x03006000},
#endif
#if CONFIG_MAX_CLOCK == 1836000
  { {1, 1}, 1080000,  ACPU_SCPLL, 0, 0, 1, 0x14, L2(21), 1000000, 0x03006000},
  { {1, 1}, 1134000,  ACPU_SCPLL, 0, 0, 1, 0x15, L2(21), 1000000, 0x03006000},
  { {1, 1}, 1188000,  ACPU_SCPLL, 0, 0, 1, 0x16, L2(21), 1025000, 0x03006000},
  { {1, 1}, 1242000,  ACPU_SCPLL, 0, 0, 1, 0x17, L2(21), 1050000, 0x03006000},
  { {1, 1}, 1296000,  ACPU_SCPLL, 0, 0, 1, 0x18, L2(21), 1075000, 0x03006000},
  { {1, 1}, 1350000,  ACPU_SCPLL, 0, 0, 1, 0x19, L2(21), 1100000, 0x03006000},
  { {1, 1}, 1404000,  ACPU_SCPLL, 0, 0, 1, 0x1A, L2(21), 1100000, 0x03006000},
  { {1, 1}, 1458000,  ACPU_SCPLL, 0, 0, 1, 0x1B, L2(21), 1100000, 0x03006000},
